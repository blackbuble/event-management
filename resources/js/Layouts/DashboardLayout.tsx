        ...
        <div className="min-h-screen bg-slate-50 flex font-sans">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto">
                    {impersonating && (
                        <div className="flex items-center justify-between gap-3 border-b border-amber-200 bg-amber-100 px-4 py-2 text-xs font-medium text-amber-900">
                            <span>Anda sedang menyamar sebagai {auth?.user?.name}. Tindakan di sini memengaruhi akun tersebut.</span>
                            <Link
                                href={route('impersonation.stop')}
                                method="post"
                                as="button"
                                className="shrink-0 rounded-md border border-amber-300 bg-white px-3 py-1 font-semibold text-amber-800 hover:bg-amber-50"
                            >
                                Kembali ke admin
                            </Link>
                        </div>
